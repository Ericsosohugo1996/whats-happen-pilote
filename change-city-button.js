...
function __createChangeCityButton() {
  ...
  btn.className = "btn-ghost";
   btn.innerHTML =
    '<svg width="14" height="14" viewBox="0 0 200 220"><path d="M100 20 C 62 20 34 50 34 88 C 34 116 60 142 82 162 L100 178 L118 162 C 140 142 166 116 166 88 C 166 50 138 20 100 20 Z" fill="currentColor"/></svg> <span data-i18n="Changer de ville">Changer de ville</span>';
