...
const TRANSLATIONS = {
  en: {
    ...
    "Confirmé !": "Confirmed!",
    "Souvenir": "Memory",
    "Votre événement sera visible par tous les utilisateurs de Whazup après une validation rapide (généralement sous 24h).": "Your event will be visible to all Whazup users after a quick review (usually within 24h).",
    "Titre": "Title",
    "Catégorie": "Category",
    "Date": "Date",
    "Heure": "Time",
    "Ville": "City",
    "Lieu précis": "Exact location",
    "Description": "Description",
    "Photo (optionnel)": "Photo (optional)",
    "Ex. Marché nocturne provençal": "E.g. Provençal night market",
    "Adresse ou nom du lieu": "Address or venue name",
    "Quelques mots sur l'événement…": "A few words about the event…",
    "Il sera visible par tous après validation (généralement sous 24h). Merci pour votre contribution !": "It will be visible to everyone after review (usually within 24h). Thanks for your contribution!",
    "Souvenirs": "Memories",
    "📸 Mes photos": "📸 My photos",
    "Ces photos restent sur cet appareil, dans ce navigateur — elles ne sont pas partagées avec les autres utilisateurs pour le moment.": "These photos stay on this device, in this browser — they are not shared with other users for now.",
    "🗑️ Supprimer cette photo": "🗑️ Delete this photo",
  ...
  es: {
    ...
    "Explorer": "Explorar",
    "Favoris": "Favoritos",
    "📍 Ma position": "📍 Mi ubicación",
    "Ville sélectionnée": "Ciudad seleccionada",
    "Position détectée": "Ubicación detectada",
    "📸 Mes photos de": "📸 Mis fotos de",
    "Je suis intéressé(e)": "Me interesa",
    "✓ Vous êtes intéressé(e)": "✓ Te interesa",
    "✅ J'y étais (+3 pts)": "✅ Estuve allí (+3 pts)",
    "✅ Confirmé — merci !": "✅ Confirmado — ¡gracias!",
    "📤 Inviter un ami (il reçoit 10 pts de bienvenue)": "📤 Invitar a un amigo (recibe 10 pts de bienvenida)",
    "❤️ Mes favoris": "❤️ Mis favoritos",
    "Vous n'avez pas encore de favoris. Ouvrez un événement et appuyez sur le cœur pour l'ajouter ici.": "Aún no tienes favoritos. Abre un evento y pulsa el corazón para añadirlo aquí.",
    ...
    "Rayon rapide :": "Radio rápido:",
    "Rayon précis :": "Radio preciso:",
    "Tous": "Todos",
    "Arrondissement :": "Distrito:",
    "Aucun événement ne correspond à ces filtres pour le moment. Essayez d'élargir le rayon ou les catégories.": "Ningún evento coincide con estos filtros por ahora. Prueba a ampliar el radio o las categorías.",
    ...
    "← Retour": "← Atrás",
    "Favori": "Favorito",
    "J'y étais": "Estuve allí",
    "Confirmé !": "¡Confirmado!",
    "Souvenir": "Recuerdo",
    "Votre événement sera visible par tous les utilisateurs de Whazup après une validation rapide (généralement sous 24h).": "Tu evento será visible para todos los usuarios de Whazup tras una validación rápida (normalmente en menos de 24h).",
    "Titre": "Título",
    "Catégorie": "Categoría",
    "Date": "Fecha",
    "Heure": "Hora",
    "Ville": "Ciudad",
    "Lieu précis": "Ubicación exacta",
    "Description": "Descripción",
    "Photo (optionnel)": "Foto (opcional)",
    "Ex. Marché nocturne provençal": "Ej. Mercado nocturno provenzal",
    "Adresse ou nom du lieu": "Dirección o nombre del lugar",
    "Quelques mots sur l'événement…": "Unas palabras sobre el evento…",
    "Il sera visible par tous après validation (généralement sous 24h). Merci pour votre contribution !": "Será visible para todos tras la validación (normalmente en menos de 24h). ¡Gracias por tu contribución!",
    "Souvenirs": "Recuerdos",
    "📸 Mes photos": "📸 Mis fotos",
    "Ces photos restent sur cet appareil, dans ce navigateur — elles ne sont pas partagées avec les autres utilisateurs pour le moment.": "Estas fotos permanecen en este dispositivo, en este navegador — no se comparten con otros usuarios por ahora.",
    "🗑️ Supprimer cette photo": "🗑️ Eliminar esta foto",
  ...
  de: {
    ...
    "Explorer": "Entdecken",
    "Favoris": "Favoriten",
    "📍 Ma position": "📍 Mein Standort",
    "Ville sélectionnée": "Ausgewählte Stadt",
    "Position détectée": "Standort erkannt",
    "📸 Mes photos de": "📸 Meine Fotos von",
    "Je suis intéressé(e)": "Ich bin interessiert",
    "✓ Vous êtes intéressé(e)": "✓ Du bist interessiert",
    "✅ J'y étais (+3 pts)": "✅ Ich war dort (+3 Pkt.)",
    "✅ Confirmé — merci !": "✅ Bestätigt — danke!",
    "📤 Inviter un ami (il reçoit 10 pts de bienvenue)": "📤 Freund einladen (erhält 10 Willkommenspunkte)",
    "❤️ Mes favoris": "❤️ Meine Favoriten",
    "Vous n'avez pas encore de favoris. Ouvrez un événement et appuyez sur le cœur pour l'ajouter ici.": "Du hast noch keine Favoriten. Öffne ein Event und tippe auf das Herz, um es hier hinzuzufügen.",
    ...
    "Rayon rapide :": "Schneller Radius:",
    "Rayon précis :": "Genauer Radius:",
    "Tous": "Alle",
    "Arrondissement :": "Bezirk:",
    "Aucun événement ne correspond à ces filtres pour le moment. Essayez d'élargir le rayon ou les catégories.": "Derzeit passt kein Event zu diesen Filtern. Versuche, den Radius oder die Kategorien zu erweitern.",
    ...
    "← Retour": "← Zurück",
    "Favori": "Favorit",
    "J'y étais": "Ich war dort",
    "Confirmé !": "Bestätigt!",
    "Souvenir": "Erinnerung",
    "Votre événement sera visible par tous les utilisateurs de Whazup après une validation rapide (généralement sous 24h).": "Dein Event wird nach einer schnellen Prüfung (meist innerhalb von 24 Std.) für alle Whazup-Nutzer sichtbar.",
    "Titre": "Titel",
    "Catégorie": "Kategorie",
    "Date": "Datum",
    "Heure": "Uhrzeit",
    "Ville": "Stadt",
    "Lieu précis": "Genauer Ort",
    "Description": "Beschreibung",
    "Photo (optionnel)": "Foto (optional)",
    "Ex. Marché nocturne provençal": "Z. B. Provenzalischer Nachtmarkt",
    "Adresse ou nom du lieu": "Adresse oder Name des Orts",
    "Quelques mots sur l'événement…": "Ein paar Worte zum Event…",
    "Il sera visible par tous après validation (généralement sous 24h). Merci pour votre contribution !": "Es wird nach der Prüfung (meist innerhalb von 24 Std.) für alle sichtbar sein. Danke für deinen Beitrag!",
    "Souvenirs": "Erinnerungen",
    "📸 Mes photos": "📸 Meine Fotos",
    "Ces photos restent sur cet appareil, dans ce navigateur — elles ne sont pas partagées avec les autres utilisateurs pour le moment.": "Diese Fotos bleiben auf diesem Gerät, in diesem Browser — sie werden derzeit nicht mit anderen Nutzern geteilt.",
    "🗑️ Supprimer cette photo": "🗑️ Dieses Foto löschen",
  ...
  it: {
    ...
    "Ville sélectionnée": "Città selezionata",
    "Position détectée": "Posizione rilevata",
    "📸 Mes photos de": "📸 Le mie foto di",
    "Je suis intéressé(e)": "Sono interessato/a",
    "✓ Vous êtes intéressé(e)": "✓ Sei interessato/a",
    "✅ J'y étais (+3 pts)": "✅ Ero presente (+3 pt)",
    "✅ Confirmé — merci !": "✅ Confermato — grazie!",
    "📤 Inviter un ami (il reçoit 10 pts de bienvenue)": "📤 Invita un amico (riceve 10 pt di benvenuto)",
    "❤️ Mes favoris": "❤️ I miei preferiti",
    "Vous n'avez pas encore de favoris. Ouvrez un événement et appuyez sur le cœur pour l'ajouter ici.": "Non hai ancora preferiti. Apri un evento e tocca il cuore per aggiungerlo qui.",
    "Nouvel événement": "Nuovo evento",
    "Publier l'événement": "Pubblica l'evento",
    "📩 Recevoir les nouveaux événements par email": "📩 Ricevi i nuovi eventi via email",
    "Événement envoyé !": "Evento inviato!",
    "Retour à l'accueil": "Torna alla home",
    "⚙️ Filtres": "⚙️ Filtri",
    "Catégories :": "Categorie:",
    "Rayon rapide :": "Raggio rapido:",
    "Rayon précis :": "Raggio preciso:",
    "Tous": "Tutti",
    "Arrondissement :": "Distretto:",
    "Aucun événement ne correspond à ces filtres pour le moment. Essayez d'élargir le rayon ou les catégories.": "Nessun evento corrisponde a questi filtri al momento. Prova ad ampliare il raggio o le categorie.",
    ...
    "Confirmé !": "Confermato!",
    "Souvenir": "Ricordo",
    "Votre événement sera visible par tous les utilisateurs de Whazup après une validation rapide (généralement sous 24h).": "Il tuo evento sarà visibile a tutti gli utenti di Whazup dopo una rapida convalida (di solito entro 24h).",
    "Titre": "Titolo",
    "Catégorie": "Categoria",
    "Date": "Data",
    "Heure": "Ora",
    "Ville": "Città",
    "Lieu précis": "Luogo preciso",
    "Description": "Descrizione",
    "Photo (optionnel)": "Foto (facoltativa)",
    "Ex. Marché nocturne provençal": "Es. Mercato notturno provenzale",
    "Adresse ou nom du lieu": "Indirizzo o nome del luogo",
    "Quelques mots sur l'événement…": "Qualche parola sull'evento…",
    "Il sera visible par tous après validation (généralement sous 24h). Merci pour votre contribution !": "Sarà visibile a tutti dopo la convalida (di solito entro 24h). Grazie per il tuo contributo!",
    "Souvenirs": "Ricordi",
    "📸 Mes photos": "📸 Le mie foto",
    "Ces photos restent sur cet appareil, dans ce navigateur — elles ne sont pas partagées avec les autres utilisateurs pour le moment.": "Queste foto restano su questo dispositivo, in questo browser — per ora non sono condivise con altri utenti.",
    "🗑️ Supprimer cette photo": "🗑️ Elimina questa foto",
  ...
  ja: {
    ...
    "Favoris": "お気に入り",
    "📍 Ma position": "📍 現在地",
    "Ville sélectionnée": "選択した都市",
    "Position détectée": "位置情報を検出しました",
    "📸 Mes photos de": "📸 マイフォト：",
    "Je suis intéressé(e)": "興味あり",
    "✓ Vous êtes intéressé(e)": "✓ 興味ありに設定済み",
    "✅ J'y étais (+3 pts)": "✅ 参加しました（+3 pt）",
    "✅ Confirmé — merci !": "✅ 確認しました。ありがとう！",
    "📤 Inviter un ami (il reçoit 10 pts de bienvenue)": "📤 友達を招待（10ポイント進呈）",
    "❤️ Mes favoris": "❤️ お気に入り",
    "Vous n'avez pas encore de favoris. Ouvrez un événement et appuyez sur le cœur pour l'ajouter ici.": "まだお気に入りがありません。イベントを開いてハートをタップすると追加されます。",
    "Nouvel événement": "新しいイベント",
    "Publier l'événement": "イベントを投稿",
    "📩 Recevoir les nouveaux événements par email": "📩 新着イベントをメールで受け取る",
    "Événement envoyé !": "イベントを送信しました！",
    ...
    "Tous": "すべて",
    "Arrondissement :": "地区：",
    "Aucun événement ne correspond à ces filtres pour le moment. Essayez d'élargir le rayon ou les catégories.": "現在、この条件に一致するイベントはありません。範囲やカテゴリーを広げてみてください。",
    ...
    "Confirmé !": "確認済み！",
    "Souvenir": "思い出",
    "Votre événement sera visible par tous les utilisateurs de Whazup après une validation rapide (généralement sous 24h).": "あなたのイベントは簡単な確認（通常24時間以内）の後、すべてのWhazupユーザーに公開されます。",
    "Titre": "タイトル",
    "Catégorie": "カテゴリー",
    "Date": "日付",
    "Heure": "時間",
    ...
    "Lieu précis": "詳しい場所",
    "Description": "説明",
    "Photo (optionnel)": "写真(任意)",
    "Ex. Marché nocturne provençal": "例：プロヴァンスのナイトマーケット",
    "Adresse ou nom du lieu": "住所または会場名",
    "Quelques mots sur l'événement…": "イベントについて一言…",
    "Il sera visible par tous après validation (généralement sous 24h). Merci pour votre contribution !": "確認後（通常24時間以内）に全員に公開されます。ご協力ありがとうございます！",
    "Souvenirs": "思い出",
    "📸 Mes photos": "📸 マイフォト",
    "Ces photos restent sur cet appareil, dans ce navigateur — elles ne sont pas partagées avec les autres utilisateurs pour le moment.": "これらの写真はこの端末・このブラウザにのみ保存され、現在は他のユーザーと共有されません。",
    "🗑️ Supprimer cette photo": "🗑️ この写真を削除",
  ...
  zh: {
    ...
    "Favoris": "收藏",
    "📍 Ma position": "📍 我的位置",
    "Ville sélectionnée": "已选城市",
    "Position détectée": "已检测到位置",
    "📸 Mes photos de": "📸 我的照片：",
    "Je suis intéressé(e)": "我感兴趣",
    "✓ Vous êtes intéressé(e)": "✓ 你感兴趣",
    "✅ J'y étais (+3 pts)": "✅ 我去过（+3 分）",
    "✅ Confirmé — merci !": "✅ 已确认，谢谢！",
    "📤 Inviter un ami (il reçoit 10 pts de bienvenue)": "📤 邀请好友（可获得10欢迎积分）",
    "❤️ Mes favoris": "❤️ 我的收藏",
    "Vous n'avez pas encore de favoris. Ouvrez un événement et appuyez sur le cœur pour l'ajouter ici.": "你还没有收藏。打开一个活动并点击爱心即可添加到这里。",
    "Nouvel événement": "新活动",
    "Publier l'événement": "发布活动",
    "📩 Recevoir les nouveaux événements par email": "📩 通过邮件接收新活动",
    "Événement envoyé !": "活动已提交！",
    ...
    "Tous": "全部",
    "Arrondissement :": "区：",
    "Aucun événement ne correspond à ces filtres pour le moment. Essayez d'élargir le rayon ou les catégories.": "目前没有符合这些筛选条件的活动。请尝试扩大范围或类别。",
    ...
    "Confirmé !": "已确认！",
    "Souvenir": "回忆",
    "Votre événement sera visible par tous les utilisateurs de Whazup après une validation rapide (généralement sous 24h).": "您的活动经过快速审核后（通常在24小时内）将对所有Whazup用户可见。",
    "Titre": "标题",
    "Catégorie": "类别",
    "Date": "日期",
    "Heure": "时间",
    ...
    "Lieu précis": "详细地点",
    "Description": "描述",
    "Photo (optionnel)": "照片(可选)",
    "Ex. Marché nocturne provençal": "例：普罗旺斯夜市",
    "Adresse ou nom du lieu": "地址或场地名称",
    "Quelques mots sur l'événement…": "简单描述一下活动…",
    "Il sera visible par tous après validation (généralement sous 24h). Merci pour votre contribution !": "审核后（通常在24小时内）将对所有人可见。感谢您的贡献！",
    "Souvenirs": "回忆",
    "📸 Mes photos": "📸 我的照片",
    "Ces photos restent sur cet appareil, dans ce navigateur — elles ne sont pas partagées avec les autres utilisateurs pour le moment.": "这些照片仅保存在此设备的此浏览器中——目前不会与其他用户共享。",
    "🗑️ Supprimer cette photo": "🗑️ 删除这张照片",
...
const SEED_EVENTS = [
    ...
    featured: true,
       thumb: "",
    photo: "https://commons.wikimedia.org/wiki/Special:FilePath/Pope Leo XIV on the loggia.jpg",
  ...
  },
  {
    ...
    city: "chambery",
    category: "Festival",
    title: "Foire de Savoie",
    date: "2026-09-14",
    time: "10:00",
    place: "SavoiExpo, Parc des Expositions, Chambéry",
    lat: 45.5750,
    lng: 5.8950,
    price: "Payant",
    thumb: "",
    description: "Grand rendez-vous familial et festif jusqu'au 21 septembre : gastronomie savoyarde, produits régionaux, animations et exposants.",
  },
  {
    id: "chambery-journees-patrimoine",
    scene: "village",
    city: "chambery",
    category: "À voir",
    title: "Journées européennes du Patrimoine et du Matrimoine",
    date: "2026-09-19",
    time: "10:00",
    place: "Chambéry et son agglomération",
    lat: 45.5646,
    lng: 5.9178,
    price: "Gratuit",
    thumb: "",
    description: "Visites, animations et ouvertures exceptionnelles de sites patrimoniaux dans toute l'agglomération chambérienne, les 19 et 20 septembre.",
  },
  {
    id: "chambery-festival-bd",
    scene: "festival",
    city: "chambery",
    category: "Festival",
    title: "Festival International de la Bande Dessinée",
    date: "2026-10-02",
    time: "10:00",
    place: "Chambéry",
    lat: 45.5646,
    ...
    price: "Payant",
    thumb: "",
    description: "L'un des grands rendez-vous dédiés au 9ᵉ art, dédicaces, expositions et rencontres avec des auteurs, du 2 au 4 octobre.",
  },
  {
    id: "chambery-berger-story",
    scene: "musique",
    city: "chambery",
    category: "Musique",
    title: "Berger Story — Hommage à Michel Berger",
    date: "2026-10-07",
    time: "20:00",
    place: "Le Phare, Grand Chambéry",
    lat: 45.5700,
    lng: 5.9100,
    price: "Payant",
    thumb: "",
    description: "Le Chœur Spectacul'Art rend un hommage vibrant à Michel Berger, spectacle mêlant émotion et grands classiques.",
  },
  {
    id: "chambery-legend-tour",
    scene: "musique",
    city: "chambery",
    category: "Musique",
    title: "Legend Tour by Trade Republic — Du Podcast au Show",
    date: "2026-10-16",
    time: "20:00",
    place: "Le Phare, Grand Chambéry",
    lat: 45.5700,
    ...
    price: "Payant",
    thumb: "",
    description: "Guillaume Pley accompagné de Legend pour une adaptation scénique inédite de leur célèbre podcast.",
  },
  {
    id: "aix-liberation",
    scene: "festival",
...
async function openPhotosView(city){
  ...
  document.getElementById("photos-title").textContent = t("📸 Mes photos") + " — " + CITIES[city].name;
  showView("photos");
...
const BROCANTE_CITY_SLUGS = {
  ...
  metz: "Metz-57",
  caen: "Caen-14",
  bourgenbresse: "Bourg-en-Bresse-01",
  laon: "Laon-02",
  moulins: "Moulins-03",
  digne: "Digne-les-Bains-04",
  gap: "Gap-05",
  nice: "Nice-06",
  privas: "Privas-07",
  charleville: "Charleville-Mézières-08",
  foix: "Foix-09",
  troyes: "Troyes-10",
  carcassonne: "Carcassonne-11",
  rodez: "Rodez-12",
  aurillac: "Aurillac-15",
  angouleme: "Angoulême-16",
  larochelle: "La-Rochelle-17",
  bourges: "Bourges-18",
  tulle: "Tulle-19",
  ajaccio: "Ajaccio-2A",
  bastia: "Bastia-2B",
  stbrieuc: "Saint-Brieuc-22",
  gueret: "Guéret-23",
  perigueux: "Périgueux-24",
  besancon: "Besançon-25",
  valence: "Valence-26",
  evreux: "Évreux-27",
  chartres: "Chartres-28",
  quimper: "Quimper-29",
  nimes: "Nîmes-30",
  auch: "Auch-32",
  chateauroux: "Châteauroux-36",
  tours: "Tours-37",
  grenoble: "Grenoble-38",
  lons: "Lons-le-Saunier-39",
  montdemarsan: "Mont-de-Marsan-40",
  blois: "Blois-41",
  stetienne: "Saint-Étienne-42",
  lepuy: "Le-Puy-en-Velay-43",
  orleans: "Orléans-45",
  cahors: "Cahors-46",
  agen: "Agen-47",
  mende: "Mende-48",
  stlo: "Saint-Lô-50",
  chalons: "Châlons-en-Champagne-51",
  chaumont: "Chaumont-52",
  laval: "Laval-53",
  nancy: "Nancy-54",
  barleduc: "Bar-le-Duc-55",
  vannes: "Vannes-56",
  nevers: "Nevers-58",
  beauvais: "Beauvais-60",
  alencon: "Alençon-61",
  arras: "Arras-62",
  clermont: "Clermont-Ferrand-63",
  pau: "Pau-64",
  tarbes: "Tarbes-65",
  ...
  amiens: "Amiens-80",
  albi: "Albi-81",
  montauban: "Montauban-82",
  toulon: "Toulon-83",
  laroche: "La-Roche-sur-Yon-85",
  poitiers: "Poitiers-86",
  limoges: "Limoges-87",
  epinal: "Épinal-88",
  auxerre: "Auxerre-89",
  belfort: "Belfort-90",
...
const OPENAGENDA_SOURCES = [
  ...
  { agendaId: 19327333, cityName: "Bordeaux", cityKey: "bordeaux", search: null },
  { agendaId: 4898229, cityName: "Bordeaux", cityKey: "bordeaux", search: null },
  ...
  { agendaId: 89904399, cityName: "Lille", cityKey: "lille", search: null, size: 300 },
  { agendaId: 81082452, cityName: "Lille", cityKey: "lille", search: null },
  { agendaId: 78167052, cityName: "Dijon", cityKey: "dijon", search: null, size: 300 },
  { agendaId: 19546629, cityName: "Dijon", cityKey: "dijon", search: null },
  { agendaId: 58870826, cityName: "Paris", cityKey: "paris", search: null },
  { agendaId: 19881363, cityName: "Paris", cityKey: "paris", search: null },
  ...
  { agendaId: 40184650, cityName: "Chambéry", cityKey: "chambery", search: null },
...
function renderBeenThereButton(){
  ...
  if (label) label.textContent = done ? t("Confirmé !") : t("J'y étais");
}
...
document.addEventListener("DOMContentLoaded", () => {
 ...
 document.getElementById("btn-interested").onclick = async (e) => {
  ...
  // ---- géocodage de l'adresse saisie (Nominatim/OpenStreetMap) ----
  async function geocodePlace(place, cityName) {
    try {
      const query = encodeURIComponent(place + ", " + cityName + ", France");
      ...
      console.error("Géocodage impossible :", e);
    }
    return null;
  }

  // ---- prévisualisation de la photo jointe ----
  let publishPhotoFile = null;
  ...
  if (publishPhotoInput) {
    publishPhotoInput.addEventListener("change", () => {
      publishPhotoFile = publishPhotoInput.files[0] || null;
      if (!publishPhotoFile) { publishPhotoPreview.innerHTML = ""; return; }
      const url = URL.createObjectURL(publishPhotoFile);
      publishPhotoPreview.innerHTML =
        '<div style="position:relative; width:120px; height:90px; border-radius:12px; overflow:hidden;">' +
        '<img src="' + url + '" style="width:100%; height:100%; object-fit:cover;">' +
        '<button type="button" id="publish-photo-remove" style="position:absolute; top:4px; right:4px; width:22px; height:22px; border-radius:50%; border:none; background:rgba(0,0,0,0.55); color:#fff; font-size:12px; cursor:pointer;">✕</button>' +
        "</div>";
      document.getElementById("publish-photo-remove").addEventListener("click", () => {
        publishPhotoFile = null;
  ...
  document.getElementById("publish-form").onsubmit = async (e) => {
    ...
    const eventId = "community-" + Date.now();

    // 1. on tente de localiser précisément l'adresse saisie ; à défaut, un point
    // aléatoire proche du centre-ville (comportement précédent, conservé en repli).
    let coords = await geocodePlace(place, CITIES[city].name);
    if (!coords) {
      coords = {
    ...
    // 2. on envoie la photo si l'utilisateur en a joint une.
    let photoUrl = "";
    if (publishPhotoFile) {
      try {
        const ref = firebase.storage().ref().child("communityEvents/" + eventId + ".jpg");
        await ref.put(publishPhotoFile);
    ...
    db.collection("communityEvents").doc(newEvent.id).set(newEvent)
      .then(() => {
        ...
        e.target.reset();
        publishPhotoFile = null;
        if (publishPhotoPreview) publishPhotoPreview.innerHTML = "";
        showView("confirm");
      })
      .catch(err => {
