...
const SEED_EVENTS = [
   {
    id: "chambery-jazz-swing-party",
    scene: "musique",
    city: "chambery",
    category: "Soirée",
    title: "Jazz Swing Party",
    date: "2026-09-11",
    time: "19:00",
    place: "La Base, Tiers-lieu Culturel Malraux scène nationale, Chambéry",
    lat: 45.563494, lng: 5.925456,
    price: "Gratuit",
    thumb: "",
    description: "Soirée avec DJ, démos et animations : 19h initiation, 20h DJ set. Restauration et boisson sur place, entrée libre sans inscription.",
  },
  {
    id: "chambery-mundus-trio",
    scene: "musique",
    city: "chambery",
    category: "Musique",
    title: "MUNDUS Trio",
    date: "2026-09-11",
    time: "21:00",
    place: "Jazz Club de Savoie, Chambéry",
    lat: 45.577043, lng: 5.908818,
    price: "À partir de 10 €",
    thumb: "",
    description: "Jazz contemporain, groove et échos hip-hop avec Victor Decamp (trombone), Fabien Ghirotto (batterie) et Quentin Préver (orgue Hammond). Révélation Jazz Magazine 2025.",
  },
  {
    id: "chambery-expo-nature-pinceau",
    scene: "expo",
    city: "chambery",
    category: "Expo",
    title: "Exposition : La nature au bout du pinceau",
    date: "2026-09-11",
    time: "13:00",
    place: "Maison des Arts, Saint-Alban-Leysse",
    lat: 45.582598, lng: 5.956312,
    price: "Gratuit",
    thumb: "",
    description: "Madeleine Rosaz expose des scènes de jardin et de nature en aquarelle, une libre interprétation poétique du vivant.",
  },
  {
    id: "chambery-cinema-premier-regard",
    scene: "village",
    city: "chambery",
    category: "À voir",
    title: "Cinéma : Au Premier regard",
    date: "2026-09-11",
    time: "20:00",
    place: "CinéMalraux, 58 place de la Brigade de Savoie, Chambéry",
    lat: 45.563528, lng: 5.925474,
    price: "7 € (5 € tarif réduit)",
    thumb: "",
    description: "Leonardo, 15 ans, est aveugle. Il aimerait être plus indépendant, étudier à l'étranger, mais aussi tomber amoureux. Un jour un nouvel élève entre dans sa classe… De Daniel Ribeiro, suivi d'un échange.",
  },
  {
    id: "chambery-festival-culture-queer",
    scene: "festival",
    city: "chambery",
    category: "Festival",
    title: "Festival Culture Queer",
    date: "2026-09-10",
    time: "19:00",
    place: "La Base, Tiers-lieu Culturel Malraux scène nationale, Chambéry",
    lat: 45.563494, lng: 5.925456,
    price: "Entrée libre",
    thumb: "",
    description: "LGBT+ Savoie invite à trois jours de projections, rencontres, ateliers et drag show pour célébrer des récits trop souvent invisibilisés. En partenariat avec LGBT+ Savoie et Contact Savoie.",
  },
  {
    id: "chambery-marche-halles",
    scene: "marche",
    city: "chambery",
    category: "Marché",
    title: "Marché des Halles de Chambéry",
    date: "2026-09-12",
    time: "06:00",
    place: "Les Halles, Place de Genève, Chambéry",
    lat: 45.56688, lng: 5.91906,
    price: "Entrée libre",
    thumb: "",
    description: "Marché historique du centre-ville dans les Halles rénovées : boucherie, boulangerie, fromagerie, maraîchers et fleuriste, production classique et bio. Se tient aussi chaque mardi.",
  },
  {
    id: "chambery-brocante-mensuelle",
    scene: "village",
    city: "chambery",
    category: "Brocante",
    ...
    date: "2026-09-12",
    time: "08:00",
    place: "Cœur de la ville ancienne, Chambéry",
    lat: 45.5646, lng: 5.9178,
    price: "Entrée libre",
    thumb: "",
    description: "Brocante de professionnels (une quinzaine d'exposants) au cœur de la ville ancienne : bouquinistes et art populaire. Se tient tous les deuxièmes samedis du mois.",
  }, 
  {
    id: "aix-liberation",
    scene: "festival",
...
function eventCardHTML(ev){
  ...
  return `
    <button class="event-card${ev.isPlace ? " event-card--place" : ""}" data-id="${ev.id}" data-cat="${ev.category}">
      ...
      <div class="info">
   <div class="cat">${ev.isPlace ? (ev.category === "Bar" ? "🍸 BAR" : "🏛️ À VOIR") : ev.category}</div>
